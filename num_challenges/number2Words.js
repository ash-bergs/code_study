/**
 * Details: Create a function that transforms any positive number to a string representing the number in words. The function should work for all numbers between 0 and 999999.
 * 
    number2words(0)  ==>  "zero"
    number2words(1)  ==>  "one"
    number2words(9)  ==>  "nine"
